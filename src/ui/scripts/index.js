...
import { getURLMatchCode } from './urlmatch.js';
...
export function getCoreScripts() {
	return `${getUtilsCode()}${getStateCode()}${getAuthCode()}${getOTPCode()}${getUICode()}${getSearchCode()}${getGroupsCode()}${getWebDAVCode()}${getCoreCode()}${getAppLockCode()}${getDashboardCode()}${getURLMatchCode()}${getModuleLoaderCode()}`;
}
...
export function getScripts() {
	...
	return `${getUtilsCode()}${getStateCode()}${getAuthCode()}${getOTPCode()}${getUICode()}${getSearchCode()}${getGroupsCode()}${getQRCodeCode()}${getGoogleMigrationCode()}${getExportCode()}${getImportCode()}${getBackupCode()}${getToolsCode()}${getWebDAVCode()}${getCoreCode()}${getAppLockCode()}${getDashboardCode()}${getURLMatchCode()}`;
}
